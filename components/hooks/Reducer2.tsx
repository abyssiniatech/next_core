  ...
  return (
    <div className="min-h-screen bg-indigo-900 text-white flex justify-center items-center flex-col">
      <section className="bg-indigo-700 p-10 rounded-lg shadow-lg">
        ...
        <button className="bg-teal-700 text-white px-4 py-2 rounded-lg m-2 hover:bg-teal-600" onClick={() => dispatch({type:"RESET"})}>Reset</button>
        
        <button className="bg-teal-700 text-white px-4 py-2 rounded-lg m-2 hover:bg-teal-600" onClick={() => dispatch({type:"DECREMENT"})}>Decrement</button>
